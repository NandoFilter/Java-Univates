...
public class Entrada {
    ...
    static final String OPTION_TITLE = "Selecione uma Op��o";
    ...
    public static void mostraTexto(final String titulo, final String descricao) {
     ...
     ** @return String input from the user.
     **/
    public static String leiaString(final String prompt) {
     ...
     ** @return String input from the user.
     **/
    public static String leiaString(final String prompt, final String initialValue) {
        final Object[] commentArray = { prompt, EMPTY_STRING, EMPTY_STRING };
        ...
        while (!validResponse) {
            ...
            final JDialog dialog = optionPane.createDialog(null, STRING_TITLE);

            dialog.pack();
            dialog.setVisible(true);

            final Object response = optionPane.getInputValue();
     ...
     ** @return the input character
     **/
    public static char leiaChar(final String prompt) {
     ...
     ** @return the input character
     **/
    public static char leiaChar(final String prompt, final char initialValue) {
     ...
     ** @return the input character
     **/
    public static char leiaChar(final String prompt, final String initialValue) {
        ...
        while (!validResponse) {
            ...
            optionPane.setWantsInput(true);
            optionPane.setInitialSelectionValue(initialValue); // EA: added
            final JDialog dialog = optionPane.createDialog(null, CHAR_TITLE);
            ...
            final Object input = optionPane.getInputValue();
            if (input != JOptionPane.UNINITIALIZED_VALUE) {
                ...
                if (result != null) {
                    ...
                    commentArray[1] = "Entrada Inv�lida"; // EA: corrected, no point to print null-object. Question:
     ...
     ** @return boolean selection from the user
     **/
    public static boolean leiaBoolean(final String prompt) {
     ...
     ** @return boolean selection from the user
     **/
    public static boolean leiaBoolean(final String prompt, final String trueText, final String falseText) {
        final Object[] commentArray = { prompt, EMPTY_STRING };
        boolean validResponse = false;
        int result = -1;

        while (!validResponse) {
            final Object[] options = { trueText, falseText };
            result = JOptionPane.showOptionDialog(null, commentArray, "Escolha uma Op��o", JOptionPane.YES_NO_OPTION,
    ...
    public static int leiaOpcao(final String prompt, final String option1, final String option2, final String option3) {
        final Object[] commentArray = { prompt, EMPTY_STRING };
        boolean validResponse = false;
        int result = -1;

        while (!validResponse) {
            final Object[] options = { option1, option2, option3 };
            result = JOptionPane.showOptionDialog(null, commentArray, OPTION_TITLE, JOptionPane.DEFAULT_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, // don't use a custom Icon
                    options, // the titles of buttons
                    "Op��o"); // the title of the default button, EA: CORRECTED from TRUE
    ...
    public static int leiaOpcao(final String prompt, final String option1, final String option2, final String option3,
        ...
        while (!validResponse) {
            final Object[] options = { option4, option3, option2, option1 };
            result = JOptionPane.showOptionDialog(null, commentArray, OPTION_TITLE, JOptionPane.DEFAULT_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, // don't use a custom Icon
                    options, // the titles of buttons
                    "Op��o"); // the title of the default button, EA: CORRECTED from TRUE
            ...
            /*
             * System.out.println(result); // check true or false buttons pressed if (result
             * == JOptionPane.YES_OPTION){ validResponse = true; response = 3; }else
             * if(result == JOptionPane.NO_OPTION){ validResponse = true; response = 2;
             * }else if(result == JOptionPane.CANCEL_OPTION){ validResponse = true; response
             * = 1; } else { commentArray[1] =
             * "Sele��o incorreta: escolha uma Op��o da tela"; }
             */
        }
        return -1;
    }
     ...
     ** @return the input integer
     */
    public static int leiaInt(final String prompt) {
     ...
     ** @return the input integer
     **/
    public static int leiaInt(final String prompt, final int initialValue) {
     ...
     ** @return the input integer
     **/
    public static int leiaInt(final String prompt, String initialValue) {
        final Object[] commentArray = { prompt, EMPTY_STRING, EMPTY_STRING };
        final Object[] options = { "OK" };
        ...
        while (!validResponse) {
            ...
            optionPane.setWantsInput(true);
            optionPane.setInitialSelectionValue(initialValue); // EA: added
            final JDialog dialog = optionPane.createDialog(null, INT_TITLE);
            ...
            if (input == JOptionPane.UNINITIALIZED_VALUE) {
                ...
                final String result = (String) input;
     ...
     ** @return the input double
     **/
    public static double leiaDouble(final String prompt) {
     ...
     ** @return the input double
     **/
    public static double leiaDouble(final String prompt, final double initialValue) {
     ...
     ** @return the input double
     **/
    public static double leiaDouble(final String prompt, String initialValue) {
        final Object[] options = { "OK" };
        final Object[] commentArray = { prompt, EMPTY_STRING, EMPTY_STRING };
        ...
        while (!validResponse) {
            ...
            optionPane.setWantsInput(true);
            optionPane.setInitialSelectionValue(initialValue); // EA: added
            final JDialog dialog = optionPane.createDialog(null, DOUBLE_TITLE);
